...
import bot
from bot import ACCT_TRF_AMT, ACCT_TRF_CONFIRM, ACCT_TRF_FROM, ACCT_TRF_NOTE, ACCT_TRF_TO, ADJUST_TIME, ADMIN_MENU, ADMIN_PIN, ADVPAY_ACCT, ADVPAY_AMT, ADVPAY_CONFIRM, ADVPAY_DESC, ADVPAY_DUE, ADVPAY_LIST, ADVPAY_NOTE, ADVPAY_PARTY, ADVPAY_SETTLE_CONFIRM, ASSET_CAT, ASSET_CONFIRM, ASSET_COST, ASSET_DATE, ASSET_DISPOSE_CONFIRM, ASSET_DISPOSE_DATE, ASSET_DISPOSE_PROCEEDS, ASSET_DISPOSE_QTY, ASSET_DISPOSE_SEL, ASSET_LIFE, ASSET_NAME, ASSET_PAY, ASSET_QTY, ASSET_SALVAGE, ATTEND_DEDUCT, ATTEND_LATE, ATTEND_LEAVE, ATTEND_STAFF, BOOK_CONSOLE, BOOK_DUP_WARN, BOOK_GAME, BOOK_LINK, BOOK_MEMBER, BOOK_MINS, BUNDLE_FOC, CAP_ACCT, CAP_AMT, CAP_CONFIRM, CONFIRM_SUMMARY, CONSOLE, CONSOLE_MENU, CON_ADD_ID, CON_ADD_MULT, CON_ADD_TYPE, CON_DEL_SELECT, CON_MGMT_MENU, DISCOUNT, DISC_SELECT, DISC_SET_QTY, DS_CONSOLE_IN_SESSION, DS_MEMBER_IN_SESSION, END_SESSION_SELECT, FINANCE_MENU, FIN_REPORT_MENU, FOOD_MENU, FOOD_QTY, GAME_ADD_GENRE, GAME_ADD_PLATFORM, GAME_ADD_STATUS, GAME_ADD_TITLE, GAME_CHANGE_CONS, GAME_CHANGE_GAME, GAME_DEL_SELECT, GAME_EDIT_FIELD, GAME_EDIT_SELECT, GAME_EDIT_VALUE, GAME_MENU, GINST_ADD_CONS, GINST_ADD_GAME, GINST_ADD_TYPE, GINST_DEL_CONS, GINST_DEL_GAME, GINST_MENU, GINST_VIEW_CONS, KPAY_AMT, MAIN_MENU, MEMBER, MINS, MM_LOOKUP, MM_MENU, NM_AMT, NM_CONFIRM, NM_EMAIL, NM_GIFT_PIN, NM_ID, NM_KPAY, NM_NAME, NM_PHONE, NM_REFERRAL, OPEX_ACCT, OPEX_AMT, OPEX_CAT, OPEX_CONFIRM, OPEX_DESC, OPEX_PAY, PAY_ACCT, PAY_AMOUNT, PAY_AMT, PAY_CONFIRM, PAY_DESC, PAY_DUE, PAY_METHOD, PAY_SETTLE_ACCT, PAY_SETTLE_CONFIRM, PAY_SETTLE_LIST, PAY_VENDOR, PREPAID_ACCT, PREPAID_AMT, PREPAID_CAT, PREPAID_CONFIRM, PREPAID_DESC, PREPAID_END, PREPAID_START, PROMO_SELECT, REC_ACCT, REC_AMT, REC_CONFIRM, REC_CUST, REC_DESC, REC_DUE, REC_SETTLE_ACCT, REC_SETTLE_CONFIRM, REC_SETTLE_LIST, REFERRAL_CODE, SALE_CONFIRM, SAL_ADV_AMT, SAL_ADV_CONFIRM, SAL_ADV_PAY, SAL_ADV_STAFF, SBK_CONFIRM, SBK_CONSOLE, SBK_CUST_NAME, SBK_DATE, SBK_DUR, SBK_GAME, SBK_TIME, SESSION_SHORTFALL, SHARE_CAP, SHARE_CONFIRM, SHARE_NAME, SHARE_OWN, SHARE_ROLE, SI_CART, SI_CONFIRM, SI_COST, SI_ITEM, SI_PAY, SI_PAY_SPLIT, SI_QTY, SSD_ADD_GAME, SSD_ADD_SSD, SSD_ADD_TYPE, SSD_DEL_GAME, SSD_DEL_SSD, SSD_MENU, SSD_RET_CONS, SSD_RET_GAME, SSD_VIEW_SSD, SSD_XFER_CONS, SSD_XFER_GAME, SSD_XFER_SSD, STOCK_ITEM, STOCK_MENU, STOCK_PIN, STOCK_QTY, TU_AMT, TU_CONFIRM, TU_KPAY, TU_MEMBER, WL_MENU, fallback, fetch_allowed_staff_ids, loop, n, s, staff, start, status, today, w
