...
from bot import ASSET_CATEGORIES, BTN_ADD_CONSOLE, BTN_ADD_GAME, BTN_ADD_PAY, BTN_ADMIN, BTN_ADMIN_ATTEND, BTN_ADMIN_BOOK, BTN_ADMIN_CF, BTN_ADMIN_LIB, BTN_ADMIN_PNL, BTN_ADMIN_SAL_ADV, BTN_ASSIGN_REFERRAL, BTN_ATTEND_DONE, BTN_ATTEND_SKIP, BTN_BACK, BTN_BACK_MAIN, BTN_BOOK_PROCEED, BTN_CANCEL, BTN_CANCEL_BOOKING, BTN_CASH_DOWN, BTN_CHANGE_GAME, BTN_CHECK_MEMBER, BTN_CLEAR_CART, BTN_CONFIRM_ID, BTN_CONFIRM_SAVE, BTN_CONSOLES, BTN_CONSOLE_BOOK, BTN_CONSOLE_INSTALL, BTN_CONSOLE_STATUS, BTN_CON_MANAGE, BTN_DAILY_SALES, BTN_DEL_CONSOLE, BTN_DEL_GAME, BTN_DISC_RECORD, BTN_DONE, BTN_EDIT_GAME, BTN_END_SESSION, BTN_FINANCE, BTN_FINANCIAL_REPORT, BTN_FIN_ACCTS, BTN_FIN_ADVPAY, BTN_FIN_ASSET, BTN_FIN_ASSET_DISPOSE, BTN_FIN_BACK, BTN_FIN_BS, BTN_FIN_CAPITAL, BTN_FIN_DEPR, BTN_FIN_OPEX, BTN_FIN_PAYABLE, BTN_FIN_PNL, BTN_FIN_PREPAID, BTN_FIN_PROFIT_SHARE, BTN_FIN_RECEIVABLE, BTN_FIN_REPORT, BTN_FIN_SETTLE_ADVPAY, BTN_FIN_SETTLE_PAY, BTN_FIN_SETTLE_REC, BTN_FIN_SETUP, BTN_FIN_SHAREHOLDER, BTN_FIN_TRANSFER, BTN_FIRST_PURCHASE, BTN_GAME_LIB_MENU, BTN_GINST_ADD, BTN_GINST_DISC, BTN_GINST_HDD, BTN_GINST_REMOVE, BTN_GINST_SSD, BTN_GINST_VIEW, BTN_INVENTORY_VIEW, BTN_LIST_CONSOLE, BTN_MANUAL_DISC, BTN_MEMBER_MGMT, BTN_NEW_SALE, BTN_NM_CUSTOM, BTN_NM_GIFT, BTN_NO_BACK, BTN_NO_MORE, BTN_NO_RESELECT, BTN_PAYROLL, BTN_PAY_DONE, BTN_PROMO_APPLY, BTN_PROMO_REPORTS, BTN_SAVE, BTN_SBK_CONFIRMED, BTN_SBK_CONFIRM_BOOK, BTN_SBK_CUSTOM, BTN_SBK_NEW, BTN_SBK_SKIP_GAME, BTN_SBK_SKIP_PHONE, BTN_SBK_TODAY, BTN_SBK_TOMORROW, BTN_SBK_WAITLIST, BTN_SI_ADD, BTN_SI_FINISH, BTN_SI_SPLIT, BTN_SKIP_DISC, BTN_SKIP_EMAIL, BTN_SKIP_GAME, BTN_SKIP_PHONE, BTN_SKIP_REFERRAL, BTN_SKIP_SALES, BTN_SKIP_TIMER, BTN_SSD_ADD, BTN_SSD_BLUE, BTN_SSD_GREY, BTN_SSD_MANAGE, BTN_SSD_REMOVE, BTN_SSD_RETURN, BTN_SSD_T1, BTN_SSD_TRANSFER, BTN_SSD_VIEW, BTN_STAFF_BOOK, BTN_STAFF_KPI, BTN_START_SESSION, BTN_STATUS_BOARD, BTN_STOCK_IN_M, BTN_STOCK_OUT, BTN_STOCK_UPDATE, BTN_TODAY_REPORT, BTN_TOPUP_SESSION, BTN_TOP_UP, BTN_VIEW_GAMES, BTN_VIEW_RANKS, BTN_WL_NOTIFY_NEXT, BTN_WL_REFRESH, BTN_WL_VIEW_ALL, BTN_WL_VIEW_WAITING, BTN_YES, BTN_YES_END, BTN_YES_END_SESSION, CAPITAL_ACCOUNTS, CUSTOMER_BOT_TOKEN, FINANCE_ACCOUNTS, N8N_BOOKING_WEBHOOK, N8N_SESSION_WEBHOOK, NAV_ROW, OPEX_CATEGORIES, PAY_METHODS, PREPAID_CATEGORIES, RANK_EMOJI, SSD_BTN_TO_ID, SSD_NAMES, STAFF_NOTIFY_CHAT, STOCK_ACCESS_PIN, STOCK_PIN, n, names, s
