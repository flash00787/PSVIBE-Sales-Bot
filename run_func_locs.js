...
const fs = require('fs');
const s = fs.readFileSync('/home/node/.openclaw/workspace/check_func_locations.py', 'utf8');
const b = Buffer.from(s).toString('base64');
const c = new Client();
c.on('ready', () => {
  c.exec('base64 -d > /tmp/check_func_locs.py <<< "' + b + '" && python3 /tmp/check_func_locs.py', (e, s) => {
