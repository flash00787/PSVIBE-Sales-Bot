...
const commands = [
  // Check what process PID 387 is
  'cat /proc/387/cmdline 2>/dev/null | tr "\\0" " "',
  // Check its status for priority/nice values
  'cat /proc/387/status 2>/dev/null | grep -E "^Nice\\|^Prio" | head -2',
];
