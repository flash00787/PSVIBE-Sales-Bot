...
const commands = [
  'grep -n -A30 "def _mysql_query" /root/psvibe_api_server/app.py',
  'grep -n -B5 -A20 "def _mysql_exec" /root/psvibe_api_server/app.py',
  'grep -n "cursorclass\|DictCursor\|pymysql" /root/psvibe_api_server/app.py /root/psvibe_api_server/config.py 2>/dev/null',
];
