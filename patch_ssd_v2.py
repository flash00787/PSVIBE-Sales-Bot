#!/usr/bin/env python3
"""Apply ssd_disc.py changes - using double-escapes to avoid newline/unicode issues"""
import re
...
# ── 4. Add move handlers in step_ssd_menu ──
old_block = '    if text == BTN_SSD_RETURN:'
new_block = r'''    if text == BTN_SSD_MOVE_TO_CONSOLE:
