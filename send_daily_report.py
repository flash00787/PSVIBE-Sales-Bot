...
Usage (cron):
    30 15 * * * cd /root/psvibe-sale-bot && python3 send_daily_report.py >> /tmp/daily_report_cron.log 2>&1
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/root/psvibe-sale-bot/daily_report.log"),
...
# ── Add bot to path ──
sys.path.insert(0, "/root/psvibe-sale-bot")
