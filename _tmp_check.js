...
const c = new Client();
c.on("ready", function() {
  c.exec("sed -n '100,130p' /root/psvibe-sales-bot/bot/handlers/booking_flow.py", function(err, stream) {
    let out = "";
...
c.on("error", function(e) { console.log("CONN_ERR:", e.message); process.exit(0); });
