...
async function runAll() {
  const commands = [
    {
      label: 'docker inspect env raw',
      cmd: 'docker inspect psvibe-mysql --format "{{json .Config.Env}}" 2>&1',
    },
    {
      label: 'mysql_db.py',
      cmd: 'cat /root/psvibe_api_server/mysql_db.py 2>&1',
    },
    {
      label: 'db_client.py',
      cmd: 'cat /root/psvibe_api_server/db_client.py 2>&1',
    },
  ];
