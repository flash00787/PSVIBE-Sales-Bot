...
# ── Staff Bot Whitelist (shared source of truth) ──────────────────────────────
ALLOWED_USER_IDS: set[int] = {8539344655, 8336350778, 6296803251}
try:
...
(
    ...
    NM_NAME, NM_PHONE, NM_EMAIL, NM_ID, NM_AMT, NM_KPAY, NM_REFERRAL, NM_CONFIRM, NM_GIFT_PIN,
    ...
    BOOK_LINK, BOOK_CONSOLE, BOOK_MEMBER,
    ...
    # ── Promotion selection in discount flow ──
    PROMO_SELECT,
    # ── Bundle FOC item selection ──
    BUNDLE_FOC,
    # ── Referral Code assignment ──
    REFERRAL_CODE,
    # ── Game Edit flow ──
    GAME_EDIT_SELECT, GAME_EDIT_FIELD, GAME_EDIT_VALUE,
    # ── Session Time Adjust flow ──
    ADJUST_TIME,
    # ── Waitlist Management ──
    WL_MENU,
) = range(177)
