...
from bot import (
    # Button constants
    BTN_VIEW_GAMES, BTN_ADD_GAME, BTN_CONSOLE_INSTALL, BTN_DEL_GAME,
    BTN_EDIT_GAME, BTN_DISC_RECORD, BTN_SSD_MANAGE, BTN_BACK_MAIN,
    BTN_BACK, BTN_CANCEL,
    # State constants
    GAME_MENU, GAME_ADD_TITLE, GAME_ADD_PLATFORM, GAME_ADD_GENRE,
    GAME_ADD_STATUS, GAME_DEL_SELECT,
    DISC_SELECT, DISC_SET_QTY,
    GAME_EDIT_SELECT, GAME_EDIT_FIELD, GAME_EDIT_VALUE,
    # Functions defined in bot/__init__.py
    fetch_games, fetch_console_games, get_game_lib_sh,
)
# Note: show_main_menu, show_ginst_menu, show_ssd_menu are imported
# lazily inside step_game_menu to avoid circular import with bot.handlers
...
async def step_game_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    from bot import show_main_menu, show_ginst_menu, show_ssd_menu  # noqa: F811
