    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                logging.exception("HANDLER_ERROR: send_remind_to_staff")
            ...
            if member_id not in ("Guest", "0 (Guest)", ""):
                try:
                    ...
                    logging.exception("HANDLER_ERROR: notify_customer_session_expiring")
...
async def _send_session_reminder(
    ...
    try:
        ...
        logging.exception("HANDLER_ERROR: edit_session_reminder")
...
async def cb_cancel_booking(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if cur_status in ("cancelled", "rejected", "completed"):
        try:
            ...
            logging.exception("HANDLER_ERROR: edit_wrong_status_msg")
        return
    ...
    try:
        ...
        logging.exception("HANDLER_ERROR: edit_cancel_options")
...
async def cb_cancel_with_reason(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if reason_key == "abort":
        try:
            ...
            logging.exception("HANDLER_ERROR: edit_abort_cancel")
        return
    ...
    if reason_key == "custom":
        ...
        try:
            ...
            logging.exception("HANDLER_ERROR: edit_reason_menu")
        return
...
async def _do_cancel_booking(query_or_msg, bk_id: int, staff_name: str, reason: str):
    ...
    if not result:
        ...
        try:
            ...
            logging.exception("HANDLER_ERROR: reply_cannot_cancel")
        return
    ...
    try:
        ...
        logging.exception("HANDLER_ERROR: reply_cancel_success")
    ...
    if query is not None:
        ...
        if STAFF_NOTIFY_CHAT and str(STAFF_NOTIFY_CHAT) != str(chat_id):
            try:
                ...
                logging.exception("HANDLER_ERROR: edit_extend_msg_for_customer_chat")
    else:
        ...
        if STAFF_NOTIFY_CHAT and str(STAFF_NOTIFY_CHAT) != str(chat_id):
            try:
                ...
                logging.exception("HANDLER_ERROR: edit_extend_msg_for_staff_chat")
...
async def cb_booking_arrive(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "bkarr":
        ...
        if result:
            ...
            await query.edit_message_text(f"⚠️ Update မအောင်မြင်ပ�� — Booking #{bk_id}")
