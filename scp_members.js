...
conn.on('ready', () => {
  conn.sftp((err, sftp) => {
    ...
    const readStream = fs.createReadStream('/home/node/.openclaw/workspace/fix_members.py');
    const writeStream = sftp.createWriteStream('/tmp/fix_members.py');
    writeStream.on('close', () => {
      console.log('File copied. Now running...');
      conn.exec('python3 /tmp/fix_members.py', { timeout: 30000 }, (err, stream) => {
