...
const fs = require('fs');
const s = fs.readFileSync('/home/node/.openclaw/workspace/add_replit_to_handlers.py', 'utf8');
const b = Buffer.from(s).toString('base64');
const c = new Client();
c.on('ready', () => {
  c.exec('base64 -d > /tmp/add_replit_to_handlers.py <<< "' + b + '" && python3 /tmp/add_replit_to_handlers.py', (e, s) => {
